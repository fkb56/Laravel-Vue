	...
	<div>
		...
		<div class="min-h-screen bg-gray-100">
			<nav class="bg-white border-b border-gray-100">
				<!-- section Primary Navigation Menu -->
				<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div class="flex justify-between h-16">
						<div class="flex">
							...
							<!-- section section Navigation Links -->
							<div
								class="
									hidden
									space-x-8
							...
							>
								<jet-nav-link
									:active="route().current('devis.create')"
							...
							>
								<jet-nav-link
									:active="route().current('produits.index')"
				...
				<!-- section Responsive Navigation Menu -->
				<div
					:class="{
				...
				>
					...
					<!-- section Responsive Settings Options -->
