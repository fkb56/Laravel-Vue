			...
			<header class="bg-gray-600 w-full">
				<div class="flex justify-between">
					<div class="p-1 mx-3 inline-flex items-center">
						<i
							class="fas fa-bars pr-2 text-white cursor-pointer"
							@click="sidebarToggler"
						></i>
						<inertia-link href="/" class="text-white p-2"
							>My devis</inertia-link
						>
					</div>
					<div class="p-1 flex flex-row items-center">
						...
						>
							<ul class="list-reset">
								...
								<li>
									<hr
										class="border-t mx-2 border-grey-light"
									/>
								</li>
				...
				>
					<ul class="list-reset flex flex-col">
						...
						>
							...
							>
								<i
									class="fas fa-square-full float-left mx-2"
								></i>
								Clients
								<span
									><i
